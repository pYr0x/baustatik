...
| rolled IPE/HEA | **13** | RSTAB: 5 + 5 flange, 2 web start, 1 centroid |
...
**The rolled profile keeps RSTAB's 13** and omits the flange-underside corners.
...
RSTAB prints "S-Punkt Nr. 1…13": 1–5 upper flange left to right, 6–10 lower
...
always ≤ 0. For the rolled profile we adopt RSTAB's bookkeeping, in which the
...
- **One known deviation.** At points 3 and 8 (flange centre) RSTAB prints up to
...
- **The fixture tolerance is 0.7 %, not the 0.3 % originally planned.** Not a
  concession about our arithmetic: RSTAB contradicts *itself* by up to 0.56 %
