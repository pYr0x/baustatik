---
"@baustatik/fem": major
"@baustatik/fem-element": major
"@baustatik/fem-solver": major
---

Schnittgrößen: `N`, `V` und `M` an jeder Stelle, aus Gleichgewicht statt aus dem
Stoffgesetz.
...
- **Breaking: drei Bindungsstufen.** `prepare(props, L, releases?)` bindet jetzt
  ...
  *und* falsche Stabendkräfte, beide plausibel aussehend — dieselbe Begründung
