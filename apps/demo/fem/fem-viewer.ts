 ...
 *
 * DAS GANZE Ergebnis und nicht nur `reactions`: aus ihm kommen auch die
 * Schnittgroessenverlaeufe, und zwei Felder fuer dieselbe Rechnung koennten
 * auseinanderlaufen.
 */
 ...
 *
 * Die ANWESENHEIT eines Feldes ist der Schalter; ein Haken raus heisst „Feld
 * weg", nicht „Hoehe null".
 */
...
async function solveActive(): Promise<void> {
    ...
    try {
        ...
        // ablesbar, ohne die Zahlen hier daneben zu lesen. Und mit ihnen die
        // angehakten Schnittgroessenverlaeufe — dasselbe Ergebnis, ein Pull.
        result = solved;
