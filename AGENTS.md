...
| `@baustatik/script` | Public browser-scripting DSL that builds serializable `schemaVersion: 11` model snapshots through model-owned handles. | `cross-section`, `errors`, `fem`, `fem-loads`, `material`, `steel-profiles` |
