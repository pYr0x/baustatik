 ...
 *
 * Der v8-Rumpf lag als wortgleiche Kopie in `cross-sections.test.ts`,
 * `materials.test.ts` und dreimal inline in `builder.test.ts`. Bei jedem
 * Schemabruch — und `@baustatik/script` hat inzwischen sieben davon — musste
...
/** Ein vollständiger, gültiger v8-Rumpf zum Überschreiben einzelner Felder. */
